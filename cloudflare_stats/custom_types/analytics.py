...
class AnalyticsDayData(BaseModel):
    ...
    content_type_map: Dict[str,AnalyticsContentTypeMap] = Field(..., alias="contentTypeMap")
    ...
    page_views: int = Field(..., alias="pageViews")
    requests: int
    response_status_map: Dict[str,AnalyticsResponseStatusMap] = Field(..., alias="responseStatusMap")
    threat_pathing_map: Dict[str,AnalyticsThreatPathingMap] = Field(..., alias="threatPathingMap")
